...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Fallback to log driver on local Windows setups so registration doesn't crash
        $defaultMailer = $settings->mail_server;
        if ($defaultMailer === 'sendmail' && strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
            $defaultMailer = 'log';
        }
