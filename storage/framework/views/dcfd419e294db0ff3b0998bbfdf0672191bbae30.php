...
<html lang="en" data-arp-injected="true" style="height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="icon" href="<?php echo e(asset('storage/photos/'.$settings->favicon)); ?>" type="image/png"/>
...
<body class="menuclose-right menuclose" style="position: relative; min-height: 100%; top: 0px;">
  ...
  <header class="navbar-fixed">
    <nav class="navbar navbar-toggleable-md navbar-inverse bg-faded">
      <div class="sidebar-left"> <a class="navbar-brand imglogo" href="#"><img style="width:110%; height:90%;" src="<?php echo e(asset('storage/' . $settings->logo)); ?>" ></a>
        ...
        <ul class="navbar-nav  justify-content-end">
          <li class="nav-item">
            <button class="btn-link btn userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="userpic">
                <img src="<?php echo e(asset('storage/photos/' . Auth::user()->profile_photo_path)); ?>" alt="user pic"></span> <span class="text"><?php echo e(Auth::user()->name); ?></span></button>
    ...
    <div class="user-menu-items">
      <div class="list-unstyled btn-group">
        <button class="media btn btn-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <br>
        <span class="message_userpic"><img class="d-flex" src="<?php echo e(asset('storage/photos/' . Auth::user()->profile_photo_path)); ?>" alt="Generic user image"></span>
...
<script src="<?php echo e(asset('temp/home/Chart.bundle.min.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH C:\xampppppp\htdocs\blackrock\black\resources\views/layouts/dash1.blade.php ENDPATH**/ ?>