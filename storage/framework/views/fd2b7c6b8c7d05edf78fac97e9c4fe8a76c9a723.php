                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="card shadow-sm">
                        <a href="<?php echo e(route('user.nfts.show', $nft->id)); ?>">
                            <img src="<?php echo e(asset('storage/' . $nft->image)); ?>" alt="<?php echo e($nft->name); ?>" class="card-img-top">
                        </a>
                        <div class="card-body">
...
<?php echo $__env->make('layouts.dash1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampppppp\htdocs\blackrock\black\resources\views/user/nfts/gallery.blade.php ENDPATH**/ ?>