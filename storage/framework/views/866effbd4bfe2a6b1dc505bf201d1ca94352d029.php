                            ...
                            <div class="container-fluid">
                                <div class="row row-sm ">
                                    ...
                                    <div class="text-center mt-4"  >
                                        <a href="/">
                                            <img src="<?php echo e(asset('storage/'.$settings->logo)); ?>" style="height: 60px" class="text-center" />
                                        </a>
                                    </div>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampppppp\htdocs\blackrock\black\resources\views/auth/register.blade.php ENDPATH**/ ?>