                            ...
                            <div class="col-sm-16 col-md-8 col-lg-6">
                                ...
                                <div id="bankt" style="display:none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" minlength="10" maxlength="12" class="form-control" name="account_number" placeholder="Enter Account Number" autocomplete="off" id="accountnumber" autocomplete="off">
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.dash1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampppppp\htdocs\blackrock\black\resources\views/user/withdrawals.blade.php ENDPATH**/ ?>