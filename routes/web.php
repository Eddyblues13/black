...
// New Template Routes
Route::view('software', 'home.software');
Route::view('insight', 'home.insight');
Route::view('oil-and-gas', 'home.oil-and-gas');
Route::view('option-trading', 'home.option-trading');
Route::view('option-trading-2', 'home.option-trading-2');
Route::view('futures', 'home.futures');
Route::view('futures-2', 'home.futures-2');
Route::view('swing-trading', 'home.swing-trading');
Route::view('swing-trading-2', 'home.swing-trading-2');
Route::view('live-trading', 'home.live-trading');
Route::view('live-trading-2', 'home.live-trading-2');
Route::view('option-copy-trading', 'home.option-copy-trading');
Route::view('advance-trading', 'home.advance-trading');
Route::view('advance-trading-2', 'home.advance-trading-2');
