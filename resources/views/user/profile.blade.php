    ...
    <div class="row  align-items-end  customer-profile-cover">
      ...
      <div class="container mb-2">
        <div class="row  align-items-center p-2">
          <figure class="social-profile-pic"><img src="{{ asset('storage/photos/' . Auth::user()->profile_photo_path) }}" alt=""></figure>
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-16" align="center">
                  <img style="width:220px;height:220px;" class="form-control" src="{{ asset('storage/photos/' . Auth::user()->profile_photo_path) }}">
