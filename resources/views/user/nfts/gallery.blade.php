                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="card shadow-sm">
                        <a href="{{ route('user.nfts.show', $nft->id) }}">
                            <img src="{{ asset('storage/' . $nft->image) }}" alt="{{ $nft->name }}" class="card-img-top">
                        </a>
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                                {{-- <img src="{{ asset('storage/photos/' . Auth::user()->profile_photo_path) }}" alt="Owner" class="rounded-circle me-2" width="30" height="30"> --}}
