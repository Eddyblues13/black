...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('storage/' . $nft->image) }}" alt="{{ $nft->name }}" class="nft-image" height="400">
        </div>
        ...
        <div class="col-md-6 details-container">
            ...
            <div class="d-flex align-items-center mb-3">
                <img src="{{ asset('storage/photos/' . Auth::user()->profile_photo_path) }}" class="owner-img me-2" width="30" height="30">
