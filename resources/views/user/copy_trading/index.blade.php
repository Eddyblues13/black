    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
                <img src="{{ asset('storage/' . $expert->profile_picture) }}" class="card-img-top rounded-top" alt="{{ $expert->name }}" style="height: 220px; object-fit: cover; border-top-left-radius: 15px; border-top-right-radius: 15px;">
