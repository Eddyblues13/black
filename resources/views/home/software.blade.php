...
<!-- Mirrored from karamelscript.com.ng/bmg/software by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Aug 2025 23:37:45 GMT -->
<!-- Added by HTTrack -->
<!-- Mirrored from trustwavedigitalasset.org/software.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Feb 2026 11:58:57 GMT -->
    ...
    z-index: 10;">
                <div class="page-m-intro__content">
                    <div class="page-m-intro__background page-m-intro__background--ltr" style="position: absolute;">
                        <h1 data-trans="about_page_intro_title" class="page-c-title page-m-intro__title">
                            Software</h1>
                        <p class="page-m-intro__description text" data-trans="about_page_intro_description">
                            Some of the softwares used for trading includes but not limited to the
                            following:.</p>
                    </div>
                </div>
        </div></section>
        <section class="p-home-m-seo-become-a-trader p-home__section p-home-m-seo-become-a-trader--ltr" style="margin-top: 50px;">
            <div class="page__container">
                <div class="p-home-m-seo-become-a-trader__content-wrap">
                    <h2 class="com-c-title p-home-m-seo-become-a-trader__title" data-trans="become_a_trader_title">Software
                    </h2>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">Tastytrade</h2>
                        ...
                        <div class="comp-img">
                            <img src="{{ asset('assets/tastytrade_fullcolor_RGB-300x55_(8).svg') }}">
                        </div>
                    </div>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">Tradier</h2>
                                <p class="p-home-m-seo-become-a-trader__item-text" data-trans="become_a_trader_item_1_text_1">
                        ...
                        <div class="comp-img">
                            <img src="{{ asset('assets/tradier-logo.svg') }}">
                        </div>
                    </div>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">Interactive Brokers</h2>
                                <p class="p-home-m-seo-become-a-trader__item-text" data-trans="become_a_trader_item_1_text_1">
                        ...
                        <div class="comp-img">
                            <img src="{{ asset('assets/ib-logo-text-black.svg') }}">
                        </div>
                    </div>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">Magnifi</h2>
                                <p class="p-home-m-seo-become-a-trader__item-text" data-trans="become_a_trader_item_1_text_1">
                                    Magnifi simplifies investing and democratizes investing intelligence</p>
                            </div>
                        </div>
                        <div class="comp-img">
                            <img src="{{ asset('assets/PersonalLogo-cac8adf49ad92613b03ea2ec2251d81d.svg') }}">
                        </div>
                    </div>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">Olive Invest</h2>
                                <p class="p-home-m-seo-become-a-trader__item-text" data-trans="become_a_trader_item_1_text_1">
                        ...
                        <div class="comp-img">
                            <img src="{{ asset('assets/6131d53c9d3264ee1c020fb9_logo.svg') }}" width="100%">
                        </div>
                    </div>
                    <div class="p-home-m-seo-become-a-trader__content" style="display: flex;margin-top:20px;height:250px">
                        <div class="p-home-m-seo-become-a-trader__item-wrap" style="max-width: 50%;width: 50%;height: 100%;">
                            <div class="p-home-m-seo-become-a-trader__item-wrap-content">
                                <h2 class="com-c-title p-home-m-seo-become-a-trader__item-head" data-trans="become_a_trader_item_1_head">EOption</h2>
                                <p class="p-home-m-seo-become-a-trader__item-text" data-trans="become_a_trader_item_1_text_1">
                        ...
                        <div class="comp-img">
                            <img src="{{ asset('assets/eoption-logo.png') }}" width="100%">
                        </div>
                    </div>
                </div>
        </div></section>
        ...
        <section class="p-home-m-payments p-home__section">
            <div class="page__container">
                ...
                <p class="com-c-description p-home-m-payments__desc" data-trans="home_payments_desc">Quick
                    and easy
...
<!-- Mirrored from karamelscript.com.ng/bmg/software by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Aug 2025 23:37:48 GMT -->

<!-- Mirrored from trustwavedigitalasset.org/software.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Feb 2026 11:59:01 GMT -->
</html>